...
import ./default.nix {
  ...
  bootstrapVersion = "1.77.0";

  # fetch hashes by running `print-hashes.sh ${bootstrapVersion}`
  bootstrapHashes = {
#    i686-unknown-linux-gnu = "b883b98372c91bc6aa9dc6ebb2b4e02e7dacbbc2ac1ebe55923dc37134df70a4";
    x86_64-unknown-linux-gnu = "sha256-Rzl4tvj/IWOJ+eiTFSEca2g8+VqWYZbnkUtG6M8NdPY";
...
#    riscv64gc-unknown-linux-gnu = "86561a8d630f634fdd7cb5899d40027103c907d9763a32770b7e2fd57dbd8473";
  ...
  selectRustPackage = pkgs: pkgs.rust_koe;

  #CARGO_PEDANTIC="off";
  rustcPatches = [
#    (fetchpatch {
#      url = "https://raw.githubusercontent.com/correabuscar/patches_gentoo/main/portage/dev-lang/rust.reused/1500_error_on_unused_manifest_key.patch";
#        sha256 = "sha256sum-of-the-patch-file";   # Replace with the correct SHA256 hash
#    })
    ./my_patches/1500_error_on_unused_manifest_key.patch
  ];
}
